...
public class NettyOIOChannel {
    ...
    /**
     * <pre>
     *      在此处我们使用netty帮助我们编写了一套基于OIO的阻塞案例,当然,netty的强大之处在于异步,显然此处的 旧的I/O已经过时了<br/>
     *      我们来回顾一下以下案例要做的功能点:
     *      1,创建一个事件轮询组
     ...
     *  </pre>
     */
    public static void oioServer(int port) throws Exception {
